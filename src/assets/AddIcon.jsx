...
export default function AddIcon() {
  return (
    <svg version="1.1" id="Capa_1" width={20} height={20} fill="#fff" x="0px" y="0px" viewBox="0 0 251.882 251.882" style={{ enableBackground: 'new 0 0 251.882 251.882' }} xmlSpace="preserve">
      <g>
        <path
